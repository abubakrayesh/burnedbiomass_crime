...
AOD <- list.files(path=paste0(AOD_path,"\\2002\\AOD Punjab-20200510T192217Z-002\\AOD Punjab"), 
...
# Write stata file #
write.dta(DistPunjab_sp_df, paste0("...\\Data\\Raw\\aod_fire\\smog_2002_2.dta"))
