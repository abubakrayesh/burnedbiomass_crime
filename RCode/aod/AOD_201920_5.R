...
AOD <- list.files(path=paste0(AOD_path,"\\2019-20\\AOD Punjab-20210201T035503Z-005\\AOD Punjab"), 
...
# Write stata file #
write.dta(DistPunjab_sp_df, paste0("...\\Data\\Raw\\aod_fire\\smog_201920_5.dta"))
