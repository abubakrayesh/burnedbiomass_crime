...
AOD <- list.files(path=paste0(AOD_path,"\\2006-07\\AOD Punjab-20200629T041029Z-004\\AOD Punjab"), 
...
# Write stata file #
write.dta(DistPunjab_sp_df, paste0("...\\Data\\Raw\\aod_fire\\smog_200607_4.dta"))
