...
AOD <- list.files(path=paste0(AOD_path,"\\2003\\AOD Punjab-20200516T073208Z-003\\AOD Punjab"), 
...
# Write stata file #
write.dta(DistPunjab_sp_df, paste0("...\\Data\\Raw\\aod_fire\\smog_2003_3.dta"))
