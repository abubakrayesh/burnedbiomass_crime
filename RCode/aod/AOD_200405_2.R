...
AOD <- list.files(path=paste0(AOD_path,"\\2004-05\\AOD Punjab-20200527T222907Z-002\\AOD Punjab"), 
...
# Write stata file #
write.dta(DistPunjab_sp_df, paste0("...\\Data\\Raw\\aod_fire\\smog_200405_2.dta"))
