...
AOD <- list.files(path=paste0(AOD_path,"\\2010-12\\AOD Punjab-20200915T234647Z-005\\AOD Punjab"), 
...
# Write stata file #
write.dta(DistPunjab_sp_df, paste0("...\\Data\\Raw\\aod_fire\\smog_201012_5.dta"))
