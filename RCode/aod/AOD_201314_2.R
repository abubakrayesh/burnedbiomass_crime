...
AOD <- list.files(path=paste0(AOD_path,"\\2013-14\\AOD Punjab-20200929T193916Z-002\\AOD Punjab"), 
...
# Write stata file #
write.dta(DistPunjab_sp_df, paste0("...\\Data\\Raw\\aod_fire\\smog_201314_2.dta"))
