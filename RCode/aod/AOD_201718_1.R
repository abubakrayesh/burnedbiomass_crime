...
AOD <- list.files(path=paste0(AOD_path,"\\2017-18\\AOD Punjab-20201101T165047Z-001\\AOD Punjab"), 
...
# Write stata file #
write.dta(DistPunjab_sp_df, paste0("...\\Data\\Raw\\aod_fire\\smog_201718_1.dta"))
