...
AOD <- list.files(path=paste0(AOD_path,"\\2008-09\\AOD Punjab-20200722T163326Z-001\\AOD Punjab"), 
...
# Write stata file #
write.dta(DistPunjab_sp_df, paste0("...\\Data\\Raw\\aod_fire\\smog_200809_1.dta"))
