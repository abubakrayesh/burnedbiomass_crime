...
AOD <- list.files(path=paste0(AOD_path,"\\2015-16\\AOD Punjab-20201016T193546Z-004\\AOD Punjab"), 
...
# Write stata file #
write.dta(DistPunjab_sp_df, paste0("...\\Data\\Raw\\aod_fire\\smog_201516_4.dta"))
