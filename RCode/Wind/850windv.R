...
cropwindv850 <- crop(GRIB, extent(Pakborder), snap="out")       #crop to restrict to polygon area
...
writeRaster(cropwindv850, filename=paste0("C:\\Users\\abuba\\Dropbox\\Smog- air pollution\\Data\\Wind\\windv850"), 
            format='GTiff', overwrite=TRUE)

#### Bring the raster back to extract polygons
windv_850 <- brick("C:\\Users\\abuba\\Dropbox\\Smog- air pollution\\Data\\Wind\\windv850.tif")



for(i in 1:228) {
  nam <- paste("windv850_",i,sep="")
  nam <- extract(windv_850[[i]],tehsilPak, fun=mean, na.rm=TRUE)
  tehsilPak[[paste("windv850_",i,sep="")]] <- nam[,1] 
}
...
writeOGR(tehsilPak, dsn=paste0("C:\\Users\\abuba\\Dropbox\\Smog-Crime\\Data\\Wind"), layer="windv850", driver="ESRI Shapefile", overwrite_layer = TRUE)

#### Bring in newly written shapefile 
#DistPak_precip <- readOGR(dsn=(paste0("C:\\Users\\abuba\\Dropbox\\Smog-Crime\\Data\\Wind")), layer="windv850")
...
# Write stata file #
write.dta(tehsilPak_sp_df, paste0("C:\\Users\\abuba\\Dropbox\\Smog-Crime\\Data\\Wind\\windv_850.dta"))
