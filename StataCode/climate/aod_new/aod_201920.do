****	This do file creates the various AOD variables for 2019 & 2020		****
...
use "${...}/smognew_201920_1.dta", clear
set more off

	foreach m of numlist 2/5 {
	merge 1:1 ADM3_PCODE using "${...}/smognew_201920_`m'.dta"
	drop if _merge==2
	drop _merge
	}
...
egen jun_avgt = rowmean(avg_`j'_152_1 - avg_`j'_180_3)
...
egen nov_avgt = rowmean(avg_`j'_305_1 - avg_`j'_333_3)
...
egen jun_avgt = rowmean(avg_`j'_153_1 - avg_`j'_177_2)
egen jul_avgt = rowmean(avg_`j'_183_1 - avg_`j'_212_4)
egen aug_avgt = rowmean(avg_`j'_214_1 - avg_`j'_241_1)
