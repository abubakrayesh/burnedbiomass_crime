****	This do file creates the various AOD variables for 2013 & 2014		****



*** generating 2013 data
clear
set maxvar 10000

local j = 2013

use "${...}/smognew_201314_1.dta", clear
set more off

	foreach m of numlist 2/4 {
	merge 1:1 ADM3_PCODE using "${...}/smognew_201314_`m'.dta"
	drop if _merge==2
	drop _merge
	}
...
egen jan_avgt = rowmean(avg_`j'_1_1 - avg_`j'_6_4)
egen feb_avgt = rowmean(avg_`j'_32_1 - avg_`j'_58_4)
egen mar_avgt = rowmean(avg_`j'_60_1 - avg_`j'_89_4)
egen apr_avgt = rowmean(avg_`j'_91_1 - avg_`j'_119_4)
egen may_avgt = rowmean(avg_`j'_121_1 - avg_`j'_150_4)
