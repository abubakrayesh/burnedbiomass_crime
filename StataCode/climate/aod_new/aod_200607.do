****	This do file creates the various AOD variables for 2006 & 2007		****

*** generating 2006 data
clear
set maxvar 10000

local j = 2006

use "${...}/smognew_200607_1.dta", clear
set more off

	foreach m of numlist 2/5 {
	merge 1:1 ADM3_PCODE using "${...}/smognew_200607_`m'.dta"
	drop if _merge==2
	drop _merge
	}
...
egen jan_avgt = rowmean(avg_`j'_1_1 - avg_`j'_27_4)
egen feb_avgt = rowmean(avg_`j'_32_2 - avg_`j'_58_4)
egen mar_avgt = rowmean(avg_`j'_60_1 - avg_`j'_74_2)
egen apr_avgt = rowmean(avg_`j'_91_1 - avg_`j'_119_3)
egen may_avgt = rowmean(avg_`j'_121_1 - avg_`j'_150_4)
*egen jun_avgt = rowmean(avg_`j'_152_1 - avg_`j'_180_4)		//june missing in 2007
egen jul_avgt = rowmean(avg_`j'_182_1 - avg_`j'_211_4)
egen aug_avgt = rowmean(avg_`j'_213_1 - avg_`j'_242_4)
egen sep_avgt = rowmean(avg_`j'_244_1 - avg_`j'_272_4)
egen oct_avgt = rowmean(avg_`j'_274_1 - avg_`j'_303_3)
egen nov_avgt = rowmean(avg_`j'_305_1 - avg_`j'_333_4)
egen dec_avgt = rowmean(avg_`j'_335_1 - avg_`j'_364_4)

foreach var of varlist avgt jan_avgt feb_avgt mar_avgt apr_avgt may_avgt ///
		aug_avgt sep_avgt oct_avgt nov_avgt dec_avgt	{
	rename `var' d_`var'
}
