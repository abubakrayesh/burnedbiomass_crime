****	This do file creates the various AOD variables for 2017 & 2018		****
...
use "${..}/smognew_201718_1.dta", clear
set more off

	foreach m of numlist 2/6 {
	merge 1:1 ADM3_PCODE using "${..}/smognew_201718_`m'.dta"
	drop if _merge==2
	drop _merge
	}
...
egen apr_avgt = rowmean(avg_`j'_91_1 - avg_`j'_118_4)
